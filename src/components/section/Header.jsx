  ...
  return (
    <header id="header" role="banner">
      ...
      <div className="header__sns">
        <ul>
          <li>
            <a href="https://github.com/hanjihyeong" rel="noopener noreferrer">
              <AiFillGithub />
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="https://codepen.io/hanjihyeong" rel="noopener noreferrer">
              <AiOutlineCodepen />
            </a>
          </li>
          <li>
            <a
              href="https://www.instagram.com/fe_scott_"
